...
import { ButtonClose } from '@/app/(main)/recipe/[id]/_components/ButtonClose/ButtonClose';
    ...
    <article className="-mx-6 -mt-3 flex h-full flex-col pb-4">
      <div className="relative h-80 bg-recipe-overlay">
        <Image
          ...
          fill
        />
        <div className="fixed top-3 z-10 m-auto flex w-full max-w-5xl justify-between px-6">
          <ButtonClose />
